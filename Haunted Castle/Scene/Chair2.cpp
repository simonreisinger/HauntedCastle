...
Chair2::Chair2(Shader* shader, float sposX, float sposY, float sposZ, float srotX, float srotY, float srotZ, float sscale)
{
	this->posx = sposX;
	this->posy = sposY;
	this->posz = sposZ;
	...
	const std::string& displayFile = "woodchair2/woodchair2.dae";
