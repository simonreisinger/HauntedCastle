...
Wardrobe::Wardrobe(Shader* shader, float sposX, float sposY, float sposZ, float srotX, float srotY, float srotZ, float sscale)
{
	this->posx = sposX;
	this->posy = sposY;
	this->posz = sposZ;
	...
	const std::string& displayFile = "Corona Wardrobe Set/Corona Wardrobe Set Blend.dae";
