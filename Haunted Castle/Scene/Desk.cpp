...
Desk::Desk(Shader* shader, float sposX, float sposY, float sposZ, float srotX, float srotY, float srotZ, float sscale)
{
	this->posx = sposX;
	this->posy = sposY;
	this->posz = sposZ;
	...
	//const std::string& displayFile = "test/test.dae";
	const std::string& displayFile = "desk/desk.dae";
