...
Torch2::Torch2(Shader* shader, float sposX, float sposY, float sposZ, float srotX, float srotY, float srotZ, float sscale)
{
	this->posx = sposX;
	this->posy = sposY;
	this->posz = sposZ;
	...
	const std::string& displayFile = "torch2/torch2.dae";
