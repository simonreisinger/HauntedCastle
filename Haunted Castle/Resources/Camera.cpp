...
CameraPoint(vec3(0.570977, 9.8421, 7.59239), vec3(-0.805237, 0.0257921, -0.59239), 10.0f),
...
CameraPoint(vec3(11.1419, 8.20631, 7), vec3(0.206903, 0.97803, 0.0254612), vec3(-0.339872, 0.940472, 0)),
CameraPoint(vec3(7.13014, 11.0796, 7), vec3(-0.946423, 0.125172, -0.297685), vec3(-0.996448, 0.084211, 0)),
CameraPoint(vec3(1.35267, 8.36343, 7), vec3(-0.827435, 0.166384, -0.536348), vec3(-0.0718892, -0.997413, 0)), // Chess
CameraPoint(vec3(-3.11844, 5.34151, 7), vec3(-0.388774, 0.559733, -0.731815), vec3(-0.988202, -0.153153, 0)),
CameraPoint(vec3(-6.61821, 2.93445, 7), vec3(-0.862183, -0.400674, 0.310001), vec3(0.0526176, -0.998615, 0)),
CameraPoint(vec3(-3.64812, -0.685256, 7), vec3(-0.197434, -0.96551, 0.169739), vec3(0.167324, -0.985902, 0)),
CameraPoint(vec3(-0.809727, -11.1464, 7), vec3(-0.995574, -0.0885563, 0.0314488), vec3(-0.798472, -0.602032, 0)),
CameraPoint(vec3(-1.26784, -11.2763, 7), vec3(-0.826731, -0.0181494, 0.562305), vec3(-0.997522, -0.0703515, 0), 10.0f) // Ende
};
//*/
