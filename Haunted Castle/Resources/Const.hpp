...
extern int LEVEL_OF_RENDER_QUALITY;
extern bool CGUE_L_PRESSED;
...
extern int TEXTURE_SLOT_COMBINE_SCENE;
extern int TEXTURE_SLOT_COMBINE_BLOOM;
extern int TEXTURE_SLOT_STATIC_IMAGE;
